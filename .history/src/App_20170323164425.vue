...
<style>
    ...
    .chooseTimeInput{width:100%;box-sizing: border-box;height:35px;line-height:35px;border: 1px solid #8977AF;font-size: 14px;text-indent: 1em;cursor: pointer;}
    .datePikcerInputBoX span{float: right;position: absolute;top: 0;right: 0;display: inline-block;height: 35px;line-height: 35px;padding: 0 10px;border-left: 1px solid #8977AF;cursor: pointer;}
