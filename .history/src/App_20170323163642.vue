...
<style>
    ...
    .pageBox{padding: 100px 0;width:100%;min-width: 500px;color: #666;}
    .content{margin: 0 auto;width:360px;}
    .datePikcerInputBoX{position: relative;width: 100%;background: #fff;}
    .chooseTimeInput{width:100%;box-sizing: border-box;height:35px;line-height:35px;border: 1px solid #B090F6;font-size: 14px;text-indent: 1em;cursor: pointer;}
    .datePikcerInputBoX span{float: right;position: absolute;top: 0;right: 0;display: inline-block;height: 35px;line-height: 35px;padding: 0 10px;border-left: 1px solid #B090F6;cursor: pointer;}
