...
<style>
    ...
    .pageBox{padding: 100px 0;width:100%;min-width: 500px;background: #5F64E2;}
    .content{margin: 0 auto;width:360px;background: #f8f8f8;}
    .datePikcerInputBoX{position: relative;width: 100%;}
    .chooseTimeInput{width:100%;box-sizing: border-box;height:35px;line-height:35px;border: 1px solid #eee;font-size: 14px;text-indent: 1em;cursor: pointer;}
    .datePikcerInputBoX span{float: right;position: absolute;top: 0;right: 0;display: inline-block;height: 35px;line-height: 35px;padding: 0 10px;border-left: 1px solid #eee;cursor: pointer;}
    .datePicker{margin-top:10px;}
    .datePicker{width:350px;border: 1px solid #eee;padding: 4px;}
