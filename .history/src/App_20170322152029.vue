    ...
    <div id="app">
        ...
        <div class="datePicker f_disselected" @mouseover="clearTimeWarpQue" @mouseout="hideDatePicker" v-if="showDatePickerBox">
            <div class="datePickerHead" @mouseout="hideChooseBox()" @mouseover="clearTimeQue()">
                ...
                <span @click="showChooseMonthBox()" class="chooseYearMonth">{{ chooseDatemonth }}</span>
...
<script>
    ...
    export default {
        ...
        computed: {
            days() {//生成当前月的日期数据
                const self = this;
                const tt = getDayArry(self.chooseDate.year, self.chooseDate.month, self.chooseDate.hasChoosedDay);
                console.log(tt)
                return tt;
            },
            items() {
